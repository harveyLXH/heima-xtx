...
<template>
  ...
  <view class="navbar" :style="{ padding: safeAreaInsets?.top + 'px' }">
    <view class="wrap">
      <navigator v-if="true" open-type="navigateBack" class="back icon-left"> </navigator>
      <navigator v-else url="/pages/index/index" open-type="switchTab" class="back icon-home">
      </navigator>
      <view class="title">订单详请</view>
    </view>
  </view>
  <scroll-view scroll-y class="view" id="scroller">
    <template v-if="false">
      <!-- 订单状态 -->
      <view class="overview" :style="{ paddingTop: safeAreaInsets!.top + 20 + 'px' }">
        ...
        <template v-if="true">
          ...
          <view class="tips">
            <text class="money">应付金额: ¥ 111</text>
      ...
      <view v-for="item in 3" :key="item" class="item">
        <view class="message"> 商品名称 </view>
        <view class="date">2022-02-02</view>
      </view>
      <!-- 用户收货地址 -->
      <view class="locate">
        <view class="user">收货人-14848949343</view>
      ...
      <view class="goods">
        <view class="item">
          ...
          >
            ...
            <view class="meta">
              <view class="name ellipsis">名称</view>
              <view class="type">属性</view>
              <view class="price">
                <view class="actual">
        ...
        <view class="total">
          <view class="row">
            ...
            <view class="symbol">2322</view>
          </view>
          <view class="row">
            <view class="text">运费: </view>
            <view class="symbol">1232</view>
          </view>
          <view class="row">
            <view class="text">应付金额: </view>
            <view class="symbol primary">12312</view>
          </view>
        </view>
      </view>
      ...
      <view class="detail">
        ...
        <view class="row">
          <view class="item"> 订单编号: 21312321323<text>复制</text> </view>
          <view class="item">下单时间: 2024-2-2</view>
        </view>
      </view>
